...
<html lang="pt-br">
    <head>
        ...
        <title>APARAA - Associação de Pequenos Agricultores do Assentamento 15 de Agosto</title>
        ...
        <div id="inicial">
            <div id="banner-inicial" class="bg_paralax" data-speed="15">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="imagens/banner_inicial.png" alt="APARAA - Associação de Pequenos Agricultores do Assentamento 15 de Agosto" title="APARAA - Associação de Pequenos Agricultores do Assentamento 15 de Agosto" class="img-center"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-5 col-lg-3">
                        <img src="imagens/imagem_sobre.png" class="img-float-right img-responsive" style="margin-top: 5%" alt="APARAA - Associação de Pequenos Agricultores do Assentamento 15 de Agosto" title="APARAA - Associação de Pequenos Agricultores do Assentamento 15 de Agosto"/>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <img src="imagens/cootax-itb-cooperados.png" alt="Cootax - Cooperados" title="Cootax- Figura de cooperação" class="img-float-right img-responsive"/>
